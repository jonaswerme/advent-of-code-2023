...
# This is bruteforcing the solution as single threaded execution, run at your own risk :)
# Alternative bruteforce solutions are available in the same folder to test and compare execution times
