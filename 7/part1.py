...
class Card:
    ...
    values = "23456789TJQKA"  # Order of value is important, index pos is used to compare cards
...
class Hand:
    ...
    def __lt__(self, comp):
        ...
        # Rules say we should compare cards left to right if the score is the same
        if self.power == comp.power:
    ...
    def _get_power(self, cards):
        ...
        return sorted(values.values(), reverse=True)
